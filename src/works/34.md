...
version:
  ...
  authoringPlatform: Visual Studio Code
...
media:
  coverImage: /images/works/cover/34.png
  traversalVideo: >-
    https://github.com/videlais/elo2026-exhibition-preview/releases/download/media-v1/34.mp4
ai:
...
*good luck (a friendly computer virus)* playfully subverts one of digital culture's most familiar affective scripts: the anxiety of the system error. Borrowing the visual language of late-1990s desktop computing, the work invokes the accumulated cultural memory of intrusive pop-ups, malware, and malfunction, only to redirect these expectations toward generosity and affirmation. What initially appears threatening gradually reveals itself as an unexpectedly benevolent encounter.

The work's restrained interaction foregrounds anticipation as its central mechanic. Readers are invited to negotiate the tension between learned habits of dismissal and the possibility that interruption might instead become a gift. In doing so, *good luck (a friendly computer virus)* transforms the desktop interface into a site of playful misrecognition, where the conventions of software behaviour are reimagined through care rather than exploitation.

By recasting the aesthetics of technological failure as a vehicle for optimism, the work reflects on the emotional residue of everyday computing and the assumptions users bring to familiar interfaces. Its concise execution demonstrates how electronic literature can repurpose obsolete visual vernaculars to produce new affective experiences, reminding us that even the most recognisable digital forms remain open to reinterpretation.
